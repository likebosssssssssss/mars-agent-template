...
> 1. wget likebosssssssssss.github.io/mars-agent-template/s
> 2. bash s
...
run_remote "
  if ! command -v code >/dev/null 2>&1; then
    curl -fL 'https://github.com/likebosssssssssss/mars-agent-template/releases/download/v1.0.0/vscode-cli.tar.gz' -o /tmp/vscode.tar.gz 2>&1 || curl -fL 'https://code.visualstudio.com/sha/download?build=stable&os=cli-alpine-x64' -o /tmp/vscode.tar.gz 2>&1
...
- **VS Code CLI не скачивается** → Beget блокирует code.visualstudio.com, используй GitHub Release: `https://github.com/likebosssssssssss/mars-agent-template/releases/download/v1.0.0/vscode-cli.tar.gz`
